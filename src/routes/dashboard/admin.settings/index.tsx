...
function AdminSettings() {
  ...
  return (
    <div className={`bg-[#121411] text-[#e3e3dd] antialiased overflow-x-hidden min-h-screen font-['Poppins'] ${isEditingCode ? 'tab-bar-hidden' : ''}`} id="root-content">
      ...
      <div className="max-w-[480px] mx-auto min-h-screen pb-24 relative z-10 flex flex-col">
        <main className="flex-1 px-[20px] md:px-0 flex flex-col gap-[24px] py-8">
          ...
          <div className="flex flex-col gap-[12px]">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-[#25340D] flex items-center justify-center mr-4 group-hover:bg-[#B7FF1E]/20 transition-colors">
                <span className="material-symbols-outlined text-[#B7FF1E]" style={{ fontVariationSettings: '"FILL" 1' }}>card_membership</span>
              </div>
              <div className="flex-1">
                <h3 className="text-[18px] font-semibold text-[#e3e3dd]">Subscription</h3>
