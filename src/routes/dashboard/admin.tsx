    ...
    <div className="bg-[#121411] text-[#e3e3dd] antialiased overflow-x-hidden min-h-screen font-['Poppins']">
      ...
      <nav className="bg-[#1e201d] border-t border-white/5 shadow-lg bottom-0 fixed left-0 w-full z-50 flex justify-around items-center px-4 py-2 pb-safe rounded-t-xl max-w-[480px] left-1/2 -translate-x-1/2">
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center w-[72px] h-[64px] rounded-xl transition-all duration-200 ${activeTab === 'payments' ? 'text-[#B7FF1E] bg-[#25340D]/20 scale-90' : 'text-[#C0C2B8]'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center w-[72px] h-[64px] rounded-xl transition-all duration-200 ${activeTab === 'attendance' ? 'text-[#B7FF1E] bg-[#25340D]/20 scale-90' : 'text-[#C0C2B8]'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center w-[72px] h-[64px] rounded-xl transition-all duration-200 ${activeTab === 'settings' ? 'text-[#B7FF1E] bg-[#25340D]/20 scale-90' : 'text-[#C0C2B8]'}`}
        >
