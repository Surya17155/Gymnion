    ...
    <div className="antialiased pb-[72px] glow-top min-h-screen overflow-x-hidden">
      ...
      {selectedGymForPricing && (
        <>
          ...
          />
          <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-[#121411] border-t border-white/10 rounded-t-[32px] p-6 z-[101] animate-in slide-in-from-bottom duration-300 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
