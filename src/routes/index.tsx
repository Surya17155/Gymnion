  ...
  return (
    <div className="min-h-screen bg-[#101311] text-[#F8FAF7] overflow-x-hidden">
      ...
      <section id="how-it-works" className="relative py-24 bg-[#000000] overflow-hidden">
        ...
        <main className="relative z-10 px-6 max-w-md lg:max-w-7xl mx-auto lg:translate-x-0 -translate-x-4">
          {/* Header Section */}
          ...
          {/* Timeline Section */}
          <div className="relative lg:grid lg:grid-cols-2 lg:gap-x-24 lg:gap-y-0">
